        ...
        <div class="p-grid">
            ...
            <div class="p-col-12 p-md-6">
                <div class="card ui-fluid">
                    ...
                    <div class="table p-field p-col-12 p-md-12 table table-striped" style="text-align: right;">
                        <p>
                            <hr>
                            ...
                            <strong style="font-size: 15px; font-weight: bold; color: cadetblue; margin-right: 130px;">IVA 17% </strong>Incluso<br>
                            <strong style="font-size: 15px; font-weight: bold; color: cadetblue; margin-right: 125px;">Total </strong>{{ number_format($itens->total, 2, ',','.')}}MT
