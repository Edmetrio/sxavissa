                ...
                <form action="{{ route('itemcotacao.index') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="ui-fluid p-formgrid p-grid">
                        ...
                        <div class="p-field p-col-12 p-md-6">
                            ...
                            <select name="cotacao_id" wire:model="selectedCotacao" class="form-control">
                                <option value="">Seleccione a Empresa</option>
                                @foreach($cotacaos as $c)
                                <option value="{{$c->id ?? ''}}">{{$c->nome ?? ''}}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td role="gridcell" style="display: flex; justify-content: flex-start;">
                                    <a href="" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only edit-button rounded-button ui-button-success"><span class="ui-button-icon-left ui-icon ui-c pi pi-pencil"></span><span class="ui-button-text ui-c">ui-button</span></a>
                    ...
                    <form action="{{ route('itemcotacao.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-field p-col-12 p-md-6" hidden>
                            <input name="cotacao_id" value="{{$cotacaoid->id}}" type="text" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all " />
                            <input name="valortotal" value="{{$cotacaoid->id}}" type="text" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all " />
                        </div>
                        <div class="p-field p-col-12 p-md-6">
