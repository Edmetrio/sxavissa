...
<head id="j_idt2">
    ...
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/theme.cssb74c.css?ln=primefaces-ecuador-blue&amp;v=10.0.0" />
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/primeicons/primeicons.cssced1.css?ln=primefaces&amp;v=10.0.0" />
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/components.cssced1.css?ln=primefaces&amp;v=10.0.0" />
    <script type="text/javascript" src="javax.faces.resource/jquery/jquery.jsced1.xhtml?ln=primefaces&amp;v=10.0.0"></script>
    <script type="text/javascript" src="javax.faces.resource/core.jsced1.xhtml?ln=primefaces&amp;v=10.0.0"></script>
    <script type="text/javascript" src="javax.faces.resource/components.jsced1.xhtml?ln=primefaces&amp;v=10.0.0"></script>
    <script type="text/javascript" src="javax.faces.resource/jquery/jquery-plugins.jsced1.xhtml?ln=primefaces&amp;v=10.0.0"></script>
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/toggleswitch/toggleswitch.cssced1.css?ln=primefaces&amp;v=10.0.0" />
    <script type="text/javascript" src="javax.faces.resource/toggleswitch/toggleswitch.jsced1.xhtml?ln=primefaces&amp;v=10.0.0"></script>
    <script type="text/javascript" src="{{asset('assets/javax.faces.resource/printer/printer.jsced1.xhtml?ln=primefaces&amp;v=10.0.0')}}"></script>
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/css/primeicons.css60d1.css?ln=ecuador-layout" />
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/css/primeflex.min.css60d1.css?ln=ecuador-layout" />
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/css/demo.css9b08.css?ln=demo" />
    <link type="text/css" rel="stylesheet" href="javax.faces.resource/css/layout-blue.css60d1.css?ln=ecuador-layout" />
    <script type="text/javascript">
        if (window.PrimeFaces) {
            PrimeFaces.settings.locale = 'en_US';
            PrimeFaces.settings.viewId = '/invoice.xhtml';
            PrimeFaces.settings.contextPath = '/ecuador';
            PrimeFaces.settings.cookiesSecure = false;
        }
    </script>
    <title>PrimeFaces Ecuador</title>
    <script type="text/javascript" src="javax.faces.resource/js/layout.js60d1.xhtml?ln=ecuador-layout"></script>
    <script type="text/javascript" src="javax.faces.resource/js/prism.js60d1.xhtml?ln=ecuador-layout"></script>
